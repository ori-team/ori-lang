...
> Status: **archived**  
> Original path: `docs/planning/web-templates-discussion-roadmap.md`  
> Original date: before 2026-07-27  
> Archived on: 2026-07-27  
> Category: `investigations`  
> Current replacement: `docs/ATLAS.md`  
...
| Doc | Papel |
|-----|--------|
| [BACKLOG.md](../../planning/BACKLOG.md) | Open work linguagem (web packages **não** são language-core) |
| [package-ecosystem-guidelines.md](../legacy/package-ecosystem-guidelines.md) | Convenções de packages |
