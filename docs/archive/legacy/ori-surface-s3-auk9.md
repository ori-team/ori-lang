...
> Status: **archived**  
> Original path: `docs/planning/ori-surface-s3-auk9.md`  
> Original date: before 2026-07-27  
> Archived on: 2026-07-27  
> Category: `legacy`  
> Current replacement: `docs/decisions/adr/0001-s3-language-surface.md`  
...
| Arquivo | Papel |
|---------|--------|
| [`adr-ori-surface-s3-auk9.md`](../../planning/adr-ori-surface-s3-auk9.md) | ADR aceito |
| [`pr-plan-ori-surface-s3.md`](../plans/pr-plan-ori-surface-s3.md) | **DAG `## PR Plan`** para `/execute-plan` |
