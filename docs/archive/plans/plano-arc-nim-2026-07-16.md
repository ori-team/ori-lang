...
> Status: **archived**  
> Original path: `docs/planning/plano-arc-nim-2026-07-16.md`  
> Original date: 2026-07-16  
> Archived on: 2026-07-27  
> Category: `plans`  
> Current replacement: `docs/decisions/adr/0002-arc-single-cascade-owner.md`  
...
> **Base:** nota de estudo C0 [`historico/nim-study-2026-07-16-c0.md`](../investigations/nim-study-2026-07-16-c0.md)
> (Nim `devel` @ `3bb46d3`) e direção
> [`language-direction-decisions-2026-06-30.md`](../legacy/language-direction-decisions-2026-06-30.md)
...
- O prompt mestre do programa de estudo está preservado em
  [`prompt-analisar-nim-para-ori.md`](../investigations/prompt-analisar-nim-para-ori.md)
