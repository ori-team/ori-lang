...
> Status: **archived**  
> Original path: `docs/planning/uso-real-pequeno-medio.md`  
...
**All open items live in [`BACKLOG.md`](../../planning/BACKLOG.md)** (IDs, priority, difficulty, deps, waves).  
...
|-------|----------------|
| M2 / M3 / M1 | ✅ done |
| Open work | [BACKLOG.md](../../planning/BACKLOG.md) |
