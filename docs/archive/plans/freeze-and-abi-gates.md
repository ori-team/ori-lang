...
> Status: **archived**  
> Original path: `docs/planning/freeze-and-abi-gates.md`  
> Original date: before 2026-07-27  
> Archived on: 2026-07-27  
> Category: `plans`  
> Current replacement: `docs/product/versioning.md and docs/spec/19-abi.md`  
...
| Active language backlog | see [`BACKLOG.md`](../../planning/BACKLOG.md) §2 (LANG-MEM wave) |
