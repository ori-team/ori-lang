...
> Para o roadmap atual, veja [`docs/planning/historico/PLANO-MATURIDADE-COMPLETO.md`](../../planning/historico/PLANO-MATURIDADE-COMPLETO.md).

# Plano de Correção — Bugs Remanescentes da Implementação Ori

> Status: **archived**  
> Original path: `docs/planning/historico/plano-correcao-bugs-2026-05-17.md`  
