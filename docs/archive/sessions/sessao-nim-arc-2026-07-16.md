...
> Status: **archived**  
> Original path: `docs/planning/historico/sessao-nim-arc-2026-07-16.md`  
...
2. **Estudo Nim C0 concluído** — nota em
   [`nim-study-2026-07-16-c0.md`](../investigations/nim-study-2026-07-16-c0.md)
   (glossário 18 termos, destroy path Nim vs Ori, 5 perguntas abertas).
3. **Plano ARC criado** — [`../plano-arc-nim-2026-07-16.md`](../plans/plano-arc-nim-2026-07-16.md),
