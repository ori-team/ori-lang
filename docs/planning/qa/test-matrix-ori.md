...
| 5 | Constant Folding | **Y/P** | HIR mid-end `ori_hir::optimize` (Default); unit tests; not every AST form |
| 6 | Constant Propagation | **P** | limited; full SSA prop still future |
| 7 | Dead Code Detection | **Y/P** | HIR DCE + `bind.unused_*` warns; not whole-program product gate |
