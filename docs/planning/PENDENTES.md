...
- [ ] Enviar todas as alterações locais consolidadas para o repositório remoto — **pendente de aprovação explícita do mantenedor**: requires abrir PR contra `main` + decisão sobre tag de release + GitHub Release. Não executar push direto na default automaticamente.
