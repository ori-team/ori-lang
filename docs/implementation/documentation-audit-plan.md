...
| **02** | `docs/spec/` | **Especificação normativa** em inglês (gramática, tipos, memória, ABI, stdlib) | 21 | 9.665 | `pendente` | Núcleo normativo. Auditar consistência entre os 20 capítulos após as waves recentes. |
