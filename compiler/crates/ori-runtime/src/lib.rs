...
pub unsafe extern "C" fn ori_window_create(
    ...
    let win = ori_alloc(std::mem::size_of::<OriWindow>(), Some(ori_window_dtor)) as *mut OriWindow;
    if !win.is_null() {
        std::ptr::write(
            win,
            OriWindow {
...
#[no_mangle]
pub unsafe extern "C" fn ori_window_present(win: *mut OriWindow, _pixels: *const u32, _len: i64) {
