...
impl<'src> Parser<'src> {
    ...
    fn parse_for_stmt(&mut self) -> Option<Stmt> {
        ...
        let binding = self.parse_name()?;
        let second_binding = if self.eat(&TokenKind::Comma) {
