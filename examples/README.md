...
- Prefer **`import ori.X as alias`** and selective imports on the parent.
- **Two or more imports** → use the **`imports … end`** block (or sequential `import ... as ...` lines).
  Single import may stay as `import ori.io as io`.
