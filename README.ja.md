...
- 再現: `SAMPLES=5 ./tools/bench/polyglot/run_polyglot_bench.sh`

概要（2026-07-14、ループ GC 修正 + mid-end + list スカラー inline）:
Ori は CPython より約 **30–1400×** 高速、fib で Go/Nim より速く、Rust の約
**1.5×**（list は約 **1.25×**）。詳細は上記ガイド。
## クイックスタート
